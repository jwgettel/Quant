CREATE TABLE symbols (ID BIGINT NOT NULL AUTO_INCREMENT, Symbol VARCHAR(100), Type VARCHAR(100), Expiration VARCHAR(100), PRIMARY KEY(ID));
...
CREATE TABLE strategies (ID BIGINT NOT NULL AUTO_INCREMENT, Str_Code VARCHAR(100), PRIMARY KEY(ID));
